...
{
    public class CrearFichaOrientacion
    {
        ...
        public CrearFichaOrientacion(IFichaOrientacion ficha)
        {
            _ficha = ficha;
        }
        public async Task EjecutarAsync(FichaOrientacion ficha)
        {
            //Aqui haremos validaciones
            ValidarFicha(ficha);
            await _ficha.Crear(ficha);
        }
        private void ValidarFicha(FichaOrientacion ficha)
        {
            if (ficha is null)
            {
