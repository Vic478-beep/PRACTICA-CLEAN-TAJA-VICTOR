...
{
    public class CrearAdulto
    {
        private readonly IAdulto _adulto;

        public CrearAdulto(IAdulto adulto)
        {
            _adulto = adulto;
        }
        ...
        private void ValidarAdulto(Adulto adulto)
        {
            ...
            // Validación de Edad (Regla de negocio: Adulto mayor)
            ...
            // Validación básica de teléfono (asumiendo que debe ser positivo)
