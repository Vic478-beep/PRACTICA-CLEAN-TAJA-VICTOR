...
{
    public class CrearFichaEnfermeria
    {
        private readonly IFichaEnfermeria _ficha;
        public CrearFichaEnfermeria(IFichaEnfermeria ficha)
        {
            _ficha = ficha;
        }
        public async Task EjecutarAsync(FichaEnfermeria ficha)
        {
            //Aqui haremos validaciones
            ValidarFicha(ficha);
            await _ficha.Crear(ficha);
        }
        private void ValidarFicha(FichaEnfermeria ficha)
        {
            if (ficha is null)
            {
