...
{
    public class CrearFichaFisioterapia
    {
        private readonly IFichaFisioterapia _ficha;
        public CrearFichaFisioterapia(IFichaFisioterapia ficha)
        {
            _ficha = ficha;
        }
        public async Task EjecutarAsync(FichaFisioterapia ficha)
        {
            //Aqui haremos validaciones
            ValidarFicha(ficha);
            await _ficha.Crear(ficha);
        }
        private void ValidarFicha(FichaFisioterapia ficha)
        {
            if (ficha is null)
            {
